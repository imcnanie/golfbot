...
class SteerController():
    ...
    def odomCallback(self, msg):
        ...
        if self.mode == 'main' or self.mode == 'rc' or self.mode == 'secondary':
            ...
            # Car local Vector
            d = np.array([msg.pose.covariance[6], msg.pose.covariance[7]])
            ...
            t1 = math.atan2(e[1], e[0])+math.pi/2
